    ...
    <Section eyebrow="Contact" title="Parlons de votre projet" lead="Notre équipe d'admission vous répond sous 24h ouvrées.">
      <div className="grid lg:grid-cols-2 gap-10">
        <form onSubmit={e=>{e.preventDefault(); alert('Message envoyé !');}}
          className="space-y-4 bg-surface p-8 rounded-2xl border border-surface-border">
          ...
          <div>
            ...
            <select className="w-full h-11 px-4 mt-1.5 rounded-xl border border-surface-border bg-surface text-ink">
          ...
          <div>
            ...
            <textarea rows={5} className="w-full mt-1.5 p-4 rounded-xl border border-surface-border bg-surface text-ink" />
          </div>
        ...
        <div className="space-y-4">
          ...
          <a href={SITE.addressUrl} target="_blank" rel="noopener noreferrer"
            className="p-6 bg-surface rounded-2xl border border-surface-border flex gap-4 hover:border-primary-300 transition group">
          ...
          {/* Phone */}
          <div className="p-6 bg-surface rounded-2xl border border-surface-border flex gap-4">
            <div className="w-12 h-12 rounded-xl bg-primary-50 text-primary-600 grid place-items-center shrink-0">
          ...
          <a href={`mailto:${SITE.email}`}
            className="p-6 bg-surface rounded-2xl border border-surface-border flex gap-4 hover:border-primary-300 transition">
            <div className="w-12 h-12 rounded-xl bg-primary-50 text-primary-600 grid place-items-center shrink-0">
          ...
          {/* Social quick links */}
          <div className="p-5 bg-surface rounded-2xl border border-surface-border flex gap-3">
          ...
          <iframe
            ...
            className="w-full h-72 rounded-2xl border border-surface-border"
